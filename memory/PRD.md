...
- Second data import (2026-09): user uploaded newer backup "2 .json" (same legacy schema). IMPORTANT: DB had been partially wiped beforehand (16 batches but 0 students/0 payments — pod storage reset). Imported fresh: 16 batches, 630 students (deduped name+phone), 2,100 payments, 20 activities, settings org_name=TAPASH SIR. Verified live: Dashboard 630/16/₹18,700 collected/₹5,30,700 pending; Overview 605 overdue / ₹9,39,000.
