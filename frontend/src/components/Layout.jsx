    ...
    <div className="min-h-screen pb-24">
      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <h1
            className="text-lg sm:text-2xl font-extrabold tracking-tight text-slate-900"
          ...
          <span
            className="hidden sm:inline-flex items-center gap-1 rounded-full bg-emerald-100 text-emerald-700 px-3 py-1 text-xs font-semibold"
            data-testid="license-pill"
          >
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              ...
              className="btn-press h-10 px-3 sm:px-4 rounded-xl bg-rose-50 border border-rose-200 text-rose-600 flex items-center justify-center gap-2 font-semibold hover:bg-rose-100"
              aria-label="Logout"
            >
              <LogOut size={18} />
